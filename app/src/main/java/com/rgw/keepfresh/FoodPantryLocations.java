...
public class FoodPantryLocations extends Fragment {
    View myView;
    public static final String LOG_TAG = FoodPantryLocations.class.getSimpleName();
    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.food_pantry_locations, container, false);

        Button button = (Button) myView.findViewById(R.id.map_button);
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    String urlAddress = "http://maps.google.com/maps?q=" + myLatitude + "," + myLongitude + "?z=10&q=Food Pantry";
